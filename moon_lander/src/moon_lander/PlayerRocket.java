...
public class PlayerRocket {
    ...
    public PlayerRocket()
    {
        ...
        //착륙발판 위치로 임시 변경
        x =(int) (Framework.frameWidth * 0.46); //random.nextInt(Framework.frameWidth - rocketImgWidth);
    }
    ...
    public void Draw(Graphics2D g2d)
    {
        ...
        {
        	g2d.drawImage(rocketImg, x, y + rocketImgHeight - rocketImg.getHeight(), null);
        }
